"""
Django settings for vabus_backend project.
...
SECRET_KEY = 'django-insecure-(cr&pul&xs%o$xos3if^z(37w7dfu6*h=w_-y!^sc2+1dw2jdq'
...
WSGI_APPLICATION = 'vabus_backend.wsgi.application'
